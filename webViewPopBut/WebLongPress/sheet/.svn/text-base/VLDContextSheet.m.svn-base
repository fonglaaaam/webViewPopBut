...
+ (VLDContextSheet *) linkPressWithGestureRecognizer:(UIGestureRecognizer *) gestureRecognizer
    ...
    if (view) {
        VLDContextSheetItem *item1 = [[VLDContextSheetItem alloc] initWithTitle: @""
                                                                          image: [UIImage imageNamed: @"btn_hold_share"]
                                                               highlightedImage: [UIImage imageNamed: @"btn_hold_share_drag"]];
        VLDContextSheetItem *item2 = [[VLDContextSheetItem alloc] initWithTitle: @""
                                                                          image: [UIImage imageNamed: @"btn_hold_copy"]
                                                               highlightedImage: [UIImage imageNamed: @"btn_hold_copy_drag"]];
        item1.index = 1;
        item2.index = 2;
        VLDContextSheet *control =[[VLDContextSheet alloc] initWithItems: @[item1,item2]];
        control.didSelectedBlock = didSelectedBlock;
        if (gestureRecognizer.state == UIGestureRecognizerStatePossible) {
            [control end];
            return control;
        }
        [control startWithGestureRecognizer:gestureRecognizer inView:view];
...
+ (VLDContextSheet *) imgPressWithGestureRecognizer:(UIGestureRecognizer *) gestureRecognizer
    ...
    if (view) {
//        VLDContextSheetItem *item1 = [[VLDContextSheetItem alloc] initWithTitle: @""
//                                                                          image: [UIImage imageNamed: @"btn_hold_wallpaper"]
//                                                               highlightedImage: [UIImage imageNamed: @"btn_hold_wallpaper_drag"]];
        
        VLDContextSheetItem *item2 = [[VLDContextSheetItem alloc] initWithTitle: @""
                                                                          image: [UIImage imageNamed: @"btn_hold_share"]
                                                               highlightedImage: [UIImage imageNamed: @"btn_hold_share_drag"]];
        
        VLDContextSheetItem *item3 = [[VLDContextSheetItem alloc] initWithTitle: @""
                                                                          image: [UIImage imageNamed: @"btn_hold_copy"]
                                                               highlightedImage: [UIImage imageNamed: @"btn_hold_copy_drag"]];
        
        VLDContextSheetItem *item4 = [[VLDContextSheetItem alloc] initWithTitle: @""
                                                                          image: [UIImage imageNamed: @"btn_hold_savephoto"]
                                                               highlightedImage: [UIImage imageNamed: @"btn_hold_savephoto_drag"]];
//        item1.index = 1;
        item2.index = 2;
        item3.index = 3;
        item4.index = 4;
        VLDContextSheet *control = [[VLDContextSheet alloc] initWithItems: @[ item2, item3, item4 ]];
        control.didSelectedBlock = didSelectedBlock;
        if (gestureRecognizer.state == UIGestureRecognizerStatePossible) {
            [control end];
            return control;
...
//        [self.delegate contextSheet: self didSelectItem: self.selectedItemView.item];
        if (self.didSelectedBlock) {
            self.didSelectedBlock(self.selectedItemView.item);
        }
    }else{
        if (self.didSelectedBlock) {
